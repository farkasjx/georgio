...
const LOCALES = [
  {
    ...
    ui: {
      ...
      mapOverlapIntro: 'A vonalvastagság azt mutatja, hány cikk hivatkozik át a két klaszter között — a térkép 134 kapcsolatából 68 (51%) klaszterhatáron átnyúló. A klaszterek besorolása segít a navigációban, de a témák a valóságban sokszor összefonódnak.',
      mapOverlapContext: 'Kontextus',
      mapOverlapPractice: 'Gyakorlat & eszközök',
      mapOverlapWorkflow: 'Modell-belső működés',
      mapOverlapModel: 'Modell & hardver',
      mapOverlapKnowledge: 'Tudás & kontextus',
      mapOverlapFoot: 'A legerősebb híd a Gyakorlat & eszközök és a Modell-belső működés klaszterek között van — sok cikk (pl. az agentic kódolás vagy a harness engineering) egyszerre gyakorlati eszköz és technikai mechanizmus is.',
  ...
  },
  {
    ...
    ui: {
      ...
      mapOverlapIntro: 'Line thickness shows how many articles cross-reference between the two clusters — 68 of the map\'s 134 connections (51%) cross a cluster boundary. Clustering helps with navigation, but the topics genuinely overlap a lot in reality.',
      mapOverlapContext: 'Context',
      mapOverlapPractice: 'Practice & Tools',
      mapOverlapWorkflow: 'How the Model Works',
      mapOverlapModel: 'Model & Hardware',
      mapOverlapKnowledge: 'Knowledge & Context',
      mapOverlapFoot: 'The strongest bridge is between Practice & Tools and How the Model Works — many articles (e.g. agentic coding or harness engineering) are simultaneously practical tools and technical mechanisms.',

...
const LOCALES = [
  {
    ...
    ui: {
      ...
      mapFilterFundamentals: 'Alapelmélet & architektúra',
      mapFilterTraining: 'Tanítás & finomhangolás',
      mapFilterInfra: 'Infrastruktúra & optimalizálás',
  ...
  },
  {
    ...
    ui: {
      ...
      mapFilterFundamentals: 'Fundamentals & Architecture',
      mapFilterTraining: 'Training & Fine-tuning',
      mapFilterInfra: 'Infrastructure & Optimization',
